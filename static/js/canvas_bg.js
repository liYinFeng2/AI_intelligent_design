var canvas = document.getElementById("canvas");
    ...
    var opt = {
        ...
        defaultSpeed: -0.06,        //粒子运动速度
        variantSpeed: -1,        //粒子运动速度的变量
        particleColor: "#fff",       //粒子的颜色
    ...
    function Partical(){
        ...
        this.border = function(){               //判断粒子是都到达边界
            ...
            if(this.y >= h){     //如果到达上下边界，就让y轴的速度变为原来的负数
                this.vector.y *= 1;
            }
            if(this.y <= 0){     //如果到达上下边界，就让y轴的速度变为原来的负数
                this.y = h;
            }
